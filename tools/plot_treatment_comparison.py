...
Generates two variants: v1 at latest step (up to 2000) and v1 capped at step 1000.
"""
import json
import matplotlib
matplotlib.use('Agg')
...
make_plot(v1_max_step=None, out_path=out_dir / "treatment_comparison_v1latest.png",
          subtitle_v1_step="latest (up to 2000)")
make_plot(v1_max_step=1000, out_path=out_dir / "treatment_comparison_v1s1000.png",
