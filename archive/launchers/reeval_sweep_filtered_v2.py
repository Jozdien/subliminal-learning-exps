"""Launch 10K-sample re-evaluations for v4 filtered RL checkpoints.

Scans results/rl_v4_filtered/{config}/{animal}/wrote_this_pct_t1/seed_{seed}/run_metadata.json
